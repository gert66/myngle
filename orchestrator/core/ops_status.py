...
def collect_feedback_cases(cases_dir=FEEDBACK_CASES_DIR):
    ...
    for path in cases_dir.glob("*.json"):
        ...
        rows.append({
            ...
            "ai_interpretation": _safe_text(item.get("ai_interpretation"), 1600),
